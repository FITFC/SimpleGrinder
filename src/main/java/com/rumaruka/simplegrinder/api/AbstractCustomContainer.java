...
import com.rumaruka.simplegrinder.api.slots.GrinderSlot;
import com.rumaruka.simplegrinder.api.slots.GrinderSlotResult;
...
public class AbstractCustomContainer extends Container {
    private final IInventory furnaceInventory;
    private final IIntArray furnaceData;
    protected final World world;
    private final IRecipeType<? extends AbstractCustomRecipe> recipeType;

    protected AbstractCustomContainer(ContainerType<?> containerTypeIn, IRecipeType<? extends AbstractCustomRecipe> recipeTypeIn, int id, PlayerInventory playerInventoryIn) {
        this(containerTypeIn, recipeTypeIn, id, playerInventoryIn, new Inventory(3), new IntArray(4));
    }

    protected AbstractCustomContainer(ContainerType<?> containerTypeIn, IRecipeType<? extends AbstractCustomRecipe> recipeTypeIn, int id, PlayerInventory playerInventoryIn, IInventory furnaceInventoryIn, IIntArray furnaceDataIn) {
        ...
        this.addSlot(new GrinderSlot(this, furnaceInventoryIn, 1, 56, 53));
        this.addSlot(new GrinderSlotResult(playerInventoryIn.player, furnaceInventoryIn, 2, 116, 35));
    ...
    public boolean isFuel(ItemStack stack) {
        return TileEntityAbstractGrinder.isFuel(stack);
    }
