...
public abstract class TileEntityAbstractGrinder extends LockableTileEntity implements ISidedInventory, IRecipeHolder, IRecipeHelperPopulator, ITickableTileEntity {
    ...
    protected final IIntArray furnaceData = new IIntArray() {
        public int get(int index) {
            switch(index) {
                case 0:
                    return TileEntityAbstractGrinder.this.burnTime;
                case 1:
                    return TileEntityAbstractGrinder.this.recipesUsed;
                case 2:
                    return TileEntityAbstractGrinder.this.cookTime;
                case 3:
                    return TileEntityAbstractGrinder.this.cookTimeTotal;
                default:
                    return 0;
            }
        }
        ...
        public void set(int index, int value) {
            switch(index) {
                case 0:
                    TileEntityAbstractGrinder.this.burnTime = value;
                    break;
                case 1:
                    TileEntityAbstractGrinder.this.recipesUsed = value;
                    break;
                case 2:
                    TileEntityAbstractGrinder.this.cookTime = value;
                    break;
                case 3:
                    TileEntityAbstractGrinder.this.cookTimeTotal = value;
            }
    ...
    public TileEntityAbstractGrinder(TileEntityType<?> tileTypeIn, IRecipeType<? extends AbstractCustomRecipe> recipeTypeIn) {
        super(tileTypeIn);
    ...
    public void tick() {
        ...
        if (!this.world.isRemote) {
            ...
            if (this.isBurning() || !itemstack.isEmpty() && !this.items.get(0).isEmpty()) {
                IRecipe<?> irecipe = this.world.getRecipeManager().getRecipe((IRecipeType<AbstractCustomRecipe>)this.recipeType, this, this.world).orElse(null);
    ...
    protected int getCookTime() {
        return this.world.getRecipeManager().getRecipe((IRecipeType<AbstractCustomRecipe>)this.recipeType, this, this.world).map(AbstractCustomRecipe::getCookTime).orElse(200);
    }
